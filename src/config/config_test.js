...
window.Host = {
    customer: "https://testcustomer.yingwumeijia.com/v5",  // C端接口
    employee: "https://testemployee.yingwumeijia.com/v5",  // E端接口地址
    business: "https://testbusiness.yingwumeijia.com",  // B端接口，公司列表
    console: "https://testconsole.yingwumeijia.com",  // E端接口，扫二维码
