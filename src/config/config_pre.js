...
window.Host = {
    customer: "https://precustomer.yingwumeijia.com/v5",  // 预发布版本接口
    employee: "https://preemployee.yingwumeijia.com/v5",  // 预发布版本接口
    business: "https://prebizapi.yingwumeijia.com",  // B端接口，公众平台公司列表
    console: "https://preconapi.yingwumeijia.com",  // E端接口，扫二维码
