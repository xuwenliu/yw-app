        ...
        <section class="inner" :style="{ transform: 'translate3d(0, ' + top + 'px, 0)' }">
            <header class="pull-refresh">
                <slot name="pull-refresh">
                    ...
                    <span class="refresh-tip"><Spinner type="fading-circle" :size="20"></Spinner>&nbsp;刷新中...</span>
                </slot>
            </header>
            <slot>
            </slot>
            <footer class="load-more">
                <slot name="load-more">
                    <span v-show="downFlag === false">上拉加载</span>
                    <span v-show="downFlag === true">
...
.load-more span,.pull-refresh span{
